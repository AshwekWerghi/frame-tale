    ...
    return (
        <section className="flex flex-col items-center mt-10 py-10 bg-gradient-to-r from-[#2ABBAD] via-[#2ABBAD] to-[#0777AE]">
            ...
            <div className="flex flex-wrap justify-center gap-12 mt-8 px-4">
                <ImageCard
                    imageSrc="/frame-tale/assets/rect1.svg"
                    height="265px"
                    width="265px"
                    className="w-full sm:w-[45%] md:w-[22%]"
                />
                <ImageCard
                    imageSrc="/frame-tale/assets/rect2.svg"
                    height="265px"
                    width="265px"
                    className="w-full sm:w-[45%] md:w-[22%]"
                />
                <ImageCard
                    imageSrc="/frame-tale/assets/rect3.svg"
                    height="265px"
                    width="265px"
                    className="w-full sm:w-[45%] md:w-[22%]"
                />
                <ImageCard
                    imageSrc="/frame-tale/assets/rect4.svg"
                    height="265px"
                    width="265px"
                    className="w-full sm:w-[45%] md:w-[22%]"
                />
            ...
            <div className="flex flex-wrap justify-center gap-12 mt-12 mb-8 px-4">
                <ImageCard
                    imageSrc="/frame-tale/assets/rect5.svg"
                    height="265px"
                    width="265px"
                    footerImage="/frame-tale/assets/P1.svg"
                    className="w-full sm:w-[45%] md:w-[22%]"
                />
                <ImageCard
                    imageSrc="/frame-tale/assets/rect6.svg"
                    height="265px"
                    width="265px"
                    footerImage="/frame-tale/assets/P2.svg"
                    className="w-full sm:w-[45%] md:w-[22%]"
                />
                <ImageCard
                    imageSrc="/frame-tale/assets/rect7.svg"
                    height="265px"
                    width="265px"
                    footerImage="/frame-tale/assets/P3.svg"
                    className="w-full sm:w-[45%] md:w-[22%]"
                />
                <ImageCard
                    imageSrc="/frame-tale/assets/rect8.svg"
                    height="265px"
                    width="265px"
                    className="w-full sm:w-[45%] md:w-[22%]"
                    footerImage="/frame-tale/assets/P4.svg"
                />
            </div>
