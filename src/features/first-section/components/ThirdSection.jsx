            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 justify-center">
                ...
                <div className="flex flex-col items-center sm:items-start md:col-span-1">
                    ...
                    <div className="mt-4 w-full">
                        <ImageCard
                            imageSrc="/frame-tale/assets/card1.svg"
                            height="336px"
                            width="100%"
                ...
                <div className="flex flex-col items-center sm:items-start md:col-span-1">
                    <ImageCard
                        imageSrc="/frame-tale/assets/card2.svg"
                        title="Photo Books"
                        height="440px"
                        width="100%"
                        className="w-full h-auto"
                ...
                <div className="flex flex-col items-center sm:items-start md:col-span-1">
                    <ImageCard
                        imageSrc="/frame-tale/assets/card3.svg"
                        title="Photo Prints"
                        height="440px"
                        width="100%"
                        className="w-full h-auto"
                ...
                <div className="flex flex-col gap-4 items-center sm:items-start md:col-span-1">
                    <ImageCard
                        imageSrc="/frame-tale/assets/card4.svg"
                        title="Calendars"
                        height="205px"
                        width="100%"
                        className="w-full h-auto"
                    />
                    <ImageCard
                        imageSrc="/frame-tale/assets/card5.svg"
                        title="Cards"
                        height="205px"
                        width="100%"
                        className="w-full h-auto"
